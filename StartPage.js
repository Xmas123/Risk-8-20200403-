...
<h1 class="display-sm-3 text-center">Hack the crisis</h1>
   ...
   <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 col-xl-6">
    <div class="card">
     ...
     <img class="img-fluid" src="/images/move4.jpg">
        ...
        <h1 class="text-sm center"><strong>Book evaluation and identification</strong></h1>
        <p class="lead-sm text-center">For a professional evaluation and identification of risk from our experts.</p>
